...
import { Dealer, mockMainDealers } from '@/constants/mock-data';

export default function MainDealerScreen() {
  ...
  const filteredDealers = useMemo(() => {
    if (!searchQuery) return mockMainDealers;
    return mockMainDealers.filter((d) =>
    ...
    return (
      ...
      >
        ...
        <View style={styles.dealerInfo}>
          ...
          <Text style={styles.dealerMeta}>{item.subDealersCount} sub dealers</Text>
        </View>
    ...
    <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Choose main dealer</Text>
          <Text style={styles.subtitle}>Select the main dealership you want to manage.</Text>
